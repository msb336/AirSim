...
public class AirSim : ModuleRules
{
    ...
    public AirSim(ReadOnlyTargetRules Target) : base(Target)
    {
        ...
        PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore", "ImageWrapper", "RenderCore", "RHI", "PakFile","PhysXVehicles", "PhysXVehicleLib", "PhysX", "APEX", "Landscape" });
